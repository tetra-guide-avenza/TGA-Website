                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="flex gap-3">
                            ...
                            <motion.a
                                ...
                                className="w-10 h-10 rounded-lg flex items-center justify-center bg-white/10 hover:bg-pink-500/20"
                            >
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-lg flex items-center justify-center bg-white/10 hover:bg-blue-500/20"
                            >
